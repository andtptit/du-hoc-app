...
export default function AdminUniversitiesModal({ universities, onClose }: Props) {
  ...
  const handleExportData = (topFilter: number | 'all' | 'selected') => {
    ...
    const rows = filtered.map(u => ({
      ...
      tuitionD2_3_no_topik: u.tuitionD2_3_no_topik || '',
      tuitionD2_6: u.tuitionD2_6 || '',
      ...
      calcTuitionD2_3_no_topik: u.calcTuitionD2_3_no_topik || '',
      calcTuitionD2_6: u.calcTuitionD2_6 || '',
      image: u.image,
      logoUrl: u.logoUrl || '',
      minGpaD4: u.minGpaD4,
      minGpaD2: u.minGpaD2,
      ...
      financialProof: u.financialProof || '',
    }));
    ...
    const sampleData = [
      {
        ...
        tuitionD2_3_no_topik: 'Ví dụ: 3.500.000 KRW/kỳ', tuitionD2_6: 'Ví dụ: 2.500.000 KRW/kỳ',
        ...
        calcTuitionD2_3_no_topik: '(BỎ TRỐNG)', calcTuitionD2_6: '(BỎ TRỐNG)',
        ...
        financialProof: 'Ví dụ: Sổ 10.000 USD...',
      },
      {
        ...
        tuitionD2_3_no_topik: '3.500.000 KRW/kỳ', tuitionD2_6: '2.500.000 KRW/kỳ',
        ...
        calcTuitionD2_3_no_topik: '', calcTuitionD2_6: '',
        ...
        financialProof: 'Sổ ngân hàng 10.000 USD (6 tháng trước)',
      }
    ];
        ...
        try {
          ...
          for (const row of results.data as any[]) {
            ...
            const uniData: University = {
              ...
              tuitionD2_3_no_topik: row.tuitionD2_3_no_topik || '0 KRW',
              tuitionD2_6: row.tuitionD2_6 || '0 KRW',
              ...
              calcTuitionD2_3_no_topik: row.calcTuitionD2_3_no_topik ? Number(row.calcTuitionD2_3_no_topik) : extractTuitionMin(row.tuitionD2_3_no_topik || ''),
              calcTuitionD2_6: row.calcTuitionD2_6 ? Number(row.calcTuitionD2_6) : extractTuitionMin(row.tuitionD2_6 || ''),
              image: row.image || '',
              logoUrl: row.logoUrl || '',
              ...
              financialProof: row.financialProof || '',
            };
